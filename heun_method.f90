program heun_method
    ...
    open(unit=10, file='heun.dat', status='replace', &
         action='write')
    ...
    do n = 1, nsteps
        ...
        y_predictor = y + h*k1
        k2 = f(x + h, y_predictor)

        y = y + 0.5_real64*h*(k1 + k2)
        x = x + h
    ...
    print '(A)', 'Heun integration completed.'
